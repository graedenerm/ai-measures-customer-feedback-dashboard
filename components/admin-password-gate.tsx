...
const ADMIN_PASSWORD = 'ecoplanet-admin2026'
      ...
      <div className="w-full max-w-sm rounded-2xl border p-8 shadow-2xl" style={{ backgroundColor: 'rgba(255,255,255,0.05)', borderColor: 'rgba(26,47,238,0.35)' }}>
        <div className="mb-8 flex flex-col items-center gap-3">
          ...
          <div className="text-center">
            ...
            <p className="text-sm" style={{ color: 'rgba(255,255,255,0.5)' }}>Kundenportal-Verwaltung</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            ...
            />
            {error && (
              <p className="text-xs text-red-400">Falsches Passwort.</p>
            )}
          </div>
